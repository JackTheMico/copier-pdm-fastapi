...
def get_version(dist: str = "copier-pdm-fastapi") -> str:
...
def get_debug_info() -> Environment:
    ...
    packages = ["copier-pdm-fastapi"]
    variables = ["PYTHONPATH", *[var for var in os.environ if var.startswith("COPIER_PDM_FASTAPI")]]
    return Environment(
